...
* [`src/fizz_pop/styles.cljs`](src/fizz_pop/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/fizz_pop/`](src/fizz_pop/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/fizz_pop/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `fizz-pop` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/fizz_pop/config.cljs) defaults to `true` in
...
```clj
(ns fizz-pop.example
  (:require [fizz-pop.config :as config])
